...
namespace Prime31.TransitionKit
{
	public class TransitionKit : MonoBehaviour
	{
		...
		public TransitionCanvas transcanvas;
		...
		void initialize()
		{
			...
			// var canvasPrefab = (Resources.Load("Prefabs/TransitionCanvas", (typeof(GameObject))) as GameObject);
			// var canvasObj = (GameObject) Instantiate(canvasPrefab, Vector3.zero, Quaternion.identity);
			// DontDestroyOnLoad( canvasObj );
			// transcanvas = canvasObj.GetComponent<TransitionCanvas>();
		...
		IEnumerator setupCameraAndTexture()
		{
			...
			//transcanvas.textureImage.material = material;
