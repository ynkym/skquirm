// Forked from http://wiki.unity3d.com/index.php/Shield
...
void surf (Input IN, inout EditorSurfaceOutput o)
{
    ...
    float4 ScreenDepthDiff0= LinearEyeDepth (
    tex2Dproj(_CameraDepthTexture, UNITY_PROJ_COORD(IN.screenPos)).r) - IN.screenPos.z;
